...
def main(argv: list[str] | None = None) -> int:
    ...
    data = json.loads(args.evals_path.read_text(encoding="utf-8"))
    ...
    report_path.write_text(build_migration_report(skill_doc_entries, args.evals_path), encoding="utf-8")
